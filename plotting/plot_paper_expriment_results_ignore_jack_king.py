...
pytorch_files = "results/leduc_ignore_jack_king_pytorch*"
pt_splines_files = "results/leduc_ignore_jack_king_pt_splines*"
pt_dt_files = "results/leduc_ignore_jack_king_pt_dt*"
...
def load(use_log_scale):
    ...
    load_and_plot(data, 4.747222222222222, "leduc_ignore_jack_king", use_log_scale)
